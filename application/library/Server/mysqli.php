...
class Server_mysqli
{
    ...
    public function getOne($tableName, $columns = '*')
    {
        ...
        if ($res instanceof Server_mysqli)
            return $res;
    ...
    public function _buildDataPairs ($tableData, $tableColumns, $isInsert) {
        foreach ($tableColumns as $column) {
            ...
            // Subquery value
            if ($value instanceof Server_mysqli) {
    ...
    */
    ...
    {
        return new Server_mysqli(Array('host' => $subQueryAlias, 'isSubQuery' => true));
    }
    ...
    public function base_query($query){
        if (!$stmt = $this->mysqli())
            throw new Exception ("get mysqli obj fail");
